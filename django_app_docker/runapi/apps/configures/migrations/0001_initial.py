    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interfaces', models.ForeignKey(help_text='所属接口', on_delete=django.db.models.deletion.CASCADE, related_name='configures', to='interfaces.interfaces', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '配置信息',
