    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='配置名称', max_length=200, verbose_name='套件名称')),
                ('include', models.TextField(help_text='包含的接口', verbose_name='包含的接口')),
                ('project', models.ForeignKey(help_text='所属接口', on_delete=django.db.models.deletion.CASCADE, related_name='testsuits', to='projects.projects', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '套件信息',
